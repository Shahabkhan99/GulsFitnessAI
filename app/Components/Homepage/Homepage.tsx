...
Click                       <Button variant="outline" onClick={generateDietPdf}>
                        <InstallIcon /> Diet_Plan.pdf
s                     </Button>
                s     <Button variant="outline" onClick={generateWoPdf}>
                        <InstallIcon /> Workout_Plan.pdf
                      </Button>
                    </div>
                  </div>
...
      {typeof aiDietResp === "string" && (
        <div className="flex flex-col justify-center items-center w-full">
Type           <div className="text-5xl my-7">Thank You!</div>
